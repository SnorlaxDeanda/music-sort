...
- **Settings** toggles for gapless, ReplayGain, smart fades, playback cache (UI-ready)
...
3. Offline download / rolling playback cache  
4. Chromecast / DLNA / Sonos casting  
5. Android Auto, Wear OS, widgets  
6. Parametric EQ + real AutoEQ/APO import  
